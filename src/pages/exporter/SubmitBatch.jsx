  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const batchData = {
        ...
        unit: data.unit,
        sourceLocation: data.sourceCountry, // Backend expects sourceLocation
        sourceCountry: data.sourceCountry,
        destinationCountry: data.destinationCountry,
        harvestDate: new Date(data.harvestDate).toISOString().split("T")[0],
        expectedExportDate: new Date(data.expectedShipmentDate)
          .toISOString()
          .split("T")[0], // Backend expects expectedExportDate
        productDescription: data.productDescription || null,
        remarks: data.farmerDetails
          ? `Farmer: ${data.farmerDetails}. Storage: ${
              data.storageConditions || "Not specified"
            }`
          : null,
      };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Fill in product details and upload relevant documents for quality
            inspection.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <select
                    {...register("unit")}
                    className="w-28 rounded-lg border border-gray-300 px-3 py-2.5 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  >
                    {UNITS.map((unit) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`block w-full rounded-lg border px-3 py-2.5 ${
                    errors.sourceCountry ? "border-red-500" : "border-gray-300"
                  } focus:ring-2 focus:ring-green-500 focus:border-transparent`}
          ...
          <div className="border-b pb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {errors.expectedShipmentDate && (
                  <p className="text-red-600 text-sm mt-1">
                    {errors.expectedShipmentDate.message}
                  </p>
                )}
              </div>
          ...
          <div>
            ...
            >
              ...
              <p className="text-sm text-gray-400 mt-1">
                Supports images (JPG, PNG) and PDFs up to 10MB each
              </p>
            </div>
